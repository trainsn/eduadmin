...
<title>登陆界面</title>
<link href="/eduadmin/Public/css/admin.css" rel="stylesheet" type="text/css" />
<style type="text/css">
    input.type{
    height:20px;
    line-height:20px;
...
<body id="login">
<form action="/eduadmin/index.php/Home/Index/check_login" target='_self'id="loginForm" method="post" name="myForm" onSubmit="return checkForm();">
	<h3>选题系统</h3>
