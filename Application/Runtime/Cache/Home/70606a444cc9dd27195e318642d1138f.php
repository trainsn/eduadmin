...
<body id="page">
<h2>修改课程</h2>
<form action="/eduadmin/index.php/Home/Index/updateCourse/id/<?php echo ($course_info["course_id"]); ?>" method="post" name="myform" onsubmit="return check();">
<table>
  <tr><th>课程编号</th><th>课程名</th>
  <th>总人数</th> 
  <th>上课教室</th><th>操作</th></tr>
  <tr>
    <td><input type="text" name="course_id" value="<?php echo ($course_info["course_id"]); ?>"></td>
    ...
    <td><input type="text" name="classroom" value="<?php echo ($course_info["classroom"]); ?>"></td>
